...
```{r}
storm <- read.csv("C:/Users/Ayoubn/Documents/R course/StormData.csv", header=TRUE, sep=",")
```
...
##Total Fatalities and Injuries by event
...
#The most harmful types of events with respect to economic impacts
